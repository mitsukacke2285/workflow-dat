...
import json
ligand_id = ligand   # dynamically detected ligand ID
#pdb_id = pdb      # dynamically detected PDB ID

with open("params.json", "w") as f:
    json.dump({"ligand_id": ligand_id, 
              "pdb_id": pdb_id
              }, f)

print(f"✅ Saved {ligand_id} and {pdb_id} to params.json")
